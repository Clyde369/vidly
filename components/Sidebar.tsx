...
const Sidebar = () => {
  ...
  return (
    <div>
      ...
      {showSideBar && (
        <div className="xl:w-400 w-20 flex flex-col justify-start mb-20 border-r-2 border-gray-100 xl:border-0 p-3">
          ...
          {!userProfile && (
            <div className="px-2 py-4 hidden xl:block">
              <p className="text-gray-400">Please log in to like and comment videos</p>
              <div className="p-r-4 ">
                <GoogleLogin 
                  clientId=""
                  render={(renderProps) => 
